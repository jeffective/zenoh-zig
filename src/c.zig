...
pub const struct_zc_shm_client_callbacks_t = extern struct {
    attach_fn: ?*const fn ([*c]struct_z_shm_segment_t, SegmentID, ?*anyopaque) callconv(.c) bool = @import("std").mem.zeroes(?*const fn ([*c]struct_z_shm_segment_t, SegmentID, ?*anyopaque) callconv(.c) bool),
};
...
pub const struct_zc_shm_provider_backend_callbacks_t = extern struct {
    alloc_fn: ?*const fn ([*c]OwnedChunkAllocResult, [*c]const struct_z_loaned_memory_layout_t, ?*anyopaque) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]OwnedChunkAllocResult, [*c]const struct_z_loaned_memory_layout_t, ?*anyopaque) callconv(.c) void),
...
pub extern fn z_alloc_layout_new(this_: [*c]OwnedAllocLayout, provider: [*c]const LoanedShmProvider, size: usize, alignment: AllocAlignment) z_result_t;
pub extern fn z_alloc_layout_threadsafe_alloc_gc_defrag_async(out_result: [*c]BufAllocResult, layout: [*c]const LoanedAllocLayout, result_context: struct_zc_threadsafe_context_t, result_callback: ?*const fn (?*anyopaque, [*c]BufAllocResult) callconv(.c) void) z_result_t;
pub extern fn z_bytes_as_loaned_shm(this_: [*c]const LoanedBytes, dst: [*c][*c]const LoanedShm) z_result_t;
pub extern fn z_bytes_as_mut_loaned_shm(this_: [*c]LoanedBytes, dst: [*c][*c]LoanedShm) z_result_t;
pub extern fn z_bytes_clone(dst: [*c]OwnedBytes, this_: [*c]const LoanedBytes) void;
pub extern fn z_bytes_copy_from_buf(this_: [*c]OwnedBytes, data: [*c]const u8, len: usize) z_result_t;
pub extern fn z_bytes_copy_from_slice(this_: [*c]OwnedBytes, slice: [*c]const LoanedSlice) void;
pub extern fn z_bytes_copy_from_str(this_: [*c]OwnedBytes, str: [*c]const u8) z_result_t;
...
pub extern fn z_bytes_from_buf(this_: [*c]OwnedBytes, data: [*c]u8, len: usize, deleter: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.c) void, context: ?*anyopaque) z_result_t;
pub extern fn z_bytes_from_shm(this_: [*c]OwnedBytes, shm: [*c]struct_z_moved_shm_t) z_result_t;
pub extern fn z_bytes_from_shm_mut(this_: [*c]OwnedBytes, shm: [*c]struct_z_moved_shm_mut_t) z_result_t;
pub extern fn z_bytes_from_slice(this_: [*c]OwnedBytes, slice: [*c]struct_z_moved_slice_t) void;
pub extern fn z_bytes_from_static_buf(this_: [*c]OwnedBytes, data: [*c]u8, len: usize) z_result_t;
pub extern fn z_bytes_from_static_str(this_: [*c]OwnedBytes, str: [*c]const u8) z_result_t;
pub extern fn z_bytes_from_str(this_: [*c]OwnedBytes, str: [*c]u8, deleter: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.c) void, context: ?*anyopaque) z_result_t;
pub extern fn z_bytes_from_string(this_: [*c]OwnedBytes, s: [*c]struct_z_moved_string_t) void;
pub extern fn z_bytes_get_contiguous_view(this_: [*c]const LoanedBytes, view: [*c]ViewSlice) z_result_t;
...
pub extern fn z_bytes_reader_seek(this_: [*c]BytesReader, offset: i64, origin: c_int) z_result_t;
...
pub extern fn z_bytes_to_owned_shm(this_: [*c]const LoanedBytes, dst: [*c]OwnedShm) z_result_t;
pub extern fn z_bytes_to_slice(this_: [*c]const LoanedBytes, dst: [*c]OwnedSlice) z_result_t;
pub extern fn z_bytes_to_string(this_: [*c]const LoanedBytes, dst: [*c]OwnedString) z_result_t;
pub extern fn z_bytes_writer_append(this_: [*c]LoanedBytesWriter, bytes: [*c]struct_z_moved_bytes_t) z_result_t;
pub extern fn z_bytes_writer_drop(this_: [*c]struct_z_moved_bytes_writer_t) void;
pub extern fn z_bytes_writer_empty(this_: [*c]OwnedBytesWriter) z_result_t;
...
pub extern fn z_bytes_writer_write_all(this_: [*c]LoanedBytesWriter, src: [*c]const u8, len: usize) z_result_t;
...
pub extern fn z_chunk_alloc_result_new_ok(this_: [*c]OwnedChunkAllocResult, allocated_chunk: AllocatedChunk) z_result_t;
...
pub extern fn z_close(session: [*c]LoanedSession, options: [*c]struct_z_close_options_t) z_result_t;
...
pub extern fn z_declare_querier(session: [*c]const LoanedSession, querier: [*c]OwnedQuerier, key_expr: [*c]const LoanedKeyexpr, options: [*c]struct_z_querier_options_t) z_result_t;
pub extern fn z_declare_queryable(session: [*c]const LoanedSession, queryable: [*c]OwnedQueryable, key_expr: [*c]const LoanedKeyexpr, callback: [*c]struct_z_moved_closure_query_t, options: [*c]struct_z_queryable_options_t) z_result_t;
pub extern fn z_declare_subscriber(session: [*c]const LoanedSession, subscriber: [*c]OwnedSubscriber, key_expr: [*c]const LoanedKeyexpr, callback: [*c]struct_z_moved_closure_sample_t, options: [*c]struct_z_subscriber_options_t) z_result_t;
...
pub extern fn z_encoding_from_str(this_: [*c]OwnedEncoding, s: [*c]const u8) z_result_t;
pub extern fn z_encoding_from_substr(this_: [*c]OwnedEncoding, s: [*c]const u8, len: usize) z_result_t;
...
pub extern fn z_encoding_set_schema_from_str(this_: [*c]LoanedEncoding, s: [*c]const u8) z_result_t;
pub extern fn z_encoding_set_schema_from_substr(this_: [*c]LoanedEncoding, s: [*c]const u8, len: usize) z_result_t;
...
pub extern fn z_fifo_handler_query_recv(this_: [*c]const LoanedFifoHandlerQuery, query: [*c]OwnedQuery) z_result_t;
pub extern fn z_fifo_handler_query_try_recv(this_: [*c]const LoanedFifoHandlerQuery, query: [*c]OwnedQuery) z_result_t;
...
pub extern fn z_fifo_handler_reply_recv(this_: [*c]const LoanedFifoHandlerReply, reply: [*c]OwnedReply) z_result_t;
pub extern fn z_fifo_handler_reply_try_recv(this_: [*c]const LoanedFifoHandlerReply, reply: [*c]OwnedReply) z_result_t;
...
pub extern fn z_fifo_handler_sample_recv(this_: [*c]const LoanedFifoHandlerSample, sample: [*c]OwnedSample) z_result_t;
pub extern fn z_fifo_handler_sample_try_recv(this_: [*c]const LoanedFifoHandlerSample, sample: [*c]OwnedSample) z_result_t;
...
pub extern fn z_liveliness_declare_subscriber(session: [*c]const LoanedSession, subscriber: [*c]OwnedSubscriber, key_expr: [*c]const LoanedKeyexpr, callback: [*c]struct_z_moved_closure_sample_t, options: [*c]struct_z_liveliness_subscriber_options_t) z_result_t;
pub extern fn z_liveliness_declare_token(session: [*c]const LoanedSession, token: [*c]OwnedLivelinessToken, key_expr: [*c]const LoanedKeyexpr, _options: [*c]const struct_z_liveliness_token_options_t) z_result_t;
...
pub extern fn z_liveliness_token_loan(this_: [*c]const OwnedLivelinessToken) [*c]const struct_z_loaned_liveliness_token_t;
...
pub extern fn z_memory_layout_get_data(this_: [*c]const struct_z_loaned_memory_layout_t, out_size: [*c]usize, out_alignment: [*c]AllocAlignment) void;
pub extern fn z_memory_layout_loan(this_: [*c]const OwnedMemoryLayout) [*c]const struct_z_loaned_memory_layout_t;
pub extern fn z_memory_layout_new(this_: [*c]OwnedMemoryLayout, size: usize, alignment: AllocAlignment) z_result_t;
pub extern fn z_mutex_drop(this_: [*c]struct_z_moved_mutex_t) void;
pub extern fn z_mutex_init(this_: [*c]OwnedMutex) z_result_t;
...
pub extern fn z_publisher_declare_matching_listener(publisher: [*c]const struct_z_loaned_publisher_t, matching_listener: [*c]OwnedMatchingListener, callback: [*c]struct_z_moved_closure_matching_status_t) z_result_t;
...
pub extern fn z_publisher_id(publisher: [*c]const struct_z_loaned_publisher_t) EntityGlobalID;
...
pub extern fn z_querier_declare_matching_listener(querier: [*c]const struct_z_loaned_querier_t, matching_listener: [*c]OwnedMatchingListener, callback: [*c]struct_z_moved_closure_matching_status_t) z_result_t;
...
pub extern fn z_querier_id(querier: [*c]const struct_z_loaned_querier_t) EntityGlobalID;
pub extern fn z_querier_keyexpr(querier: [*c]const struct_z_loaned_querier_t) [*c]const LoanedKeyexpr;
pub extern fn z_querier_loan(this_: [*c]const OwnedQuerier) [*c]const struct_z_loaned_querier_t;
pub extern fn z_querier_loan_mut(this_: [*c]OwnedQuerier) [*c]struct_z_loaned_querier_t;
...
pub extern fn z_queryable_id(queryable: [*c]const struct_z_loaned_queryable_t) EntityGlobalID;
pub extern fn z_queryable_loan(this_: [*c]const OwnedQueryable) [*c]const struct_z_loaned_queryable_t;
...
pub extern fn z_reply_err_clone(dst: [*c]OwnedReplyErr, this_: [*c]const struct_z_loaned_reply_err_t) void;
pub extern fn z_reply_err_drop(this_: [*c]struct_z_moved_reply_err_t) void;
pub extern fn z_reply_err_encoding(this_: [*c]const struct_z_loaned_reply_err_t) [*c]const LoanedEncoding;
pub extern fn z_reply_err_loan(this_: [*c]const OwnedReplyErr) [*c]const struct_z_loaned_reply_err_t;
pub extern fn z_reply_err_loan_mut(this_: [*c]OwnedReplyErr) [*c]struct_z_loaned_reply_err_t;
...
pub extern fn z_ring_handler_query_loan(this_: [*c]const OwnedRingHandlerQuery) [*c]const struct_z_loaned_ring_handler_query_t;
pub extern fn z_ring_handler_query_recv(this_: [*c]const struct_z_loaned_ring_handler_query_t, query: [*c]OwnedQuery) z_result_t;
pub extern fn z_ring_handler_query_try_recv(this_: [*c]const struct_z_loaned_ring_handler_query_t, query: [*c]OwnedQuery) z_result_t;
...
pub extern fn z_ring_handler_reply_recv(this_: [*c]const struct_z_loaned_ring_handler_reply_t, reply: [*c]OwnedReply) z_result_t;
pub extern fn z_ring_handler_reply_try_recv(this_: [*c]const struct_z_loaned_ring_handler_reply_t, reply: [*c]OwnedReply) z_result_t;
...
pub extern fn z_ring_handler_sample_recv(this_: [*c]const struct_z_loaned_ring_handler_sample_t, sample: [*c]OwnedSample) z_result_t;
pub extern fn z_ring_handler_sample_try_recv(this_: [*c]const struct_z_loaned_ring_handler_sample_t, sample: [*c]OwnedSample) z_result_t;
...
pub extern fn z_session_loan(this_: [*c]const struct_z_owned_session_t) [*c]const LoanedSession;
pub extern fn z_session_loan_mut(this_: [*c]struct_z_owned_session_t) [*c]LoanedSession;
...
pub extern fn z_shm_mut_loan(this_: [*c]const OwnedShmMut) [*c]const struct_z_loaned_shm_mut_t;
pub extern fn z_shm_mut_loan_mut(this_: [*c]OwnedShmMut) [*c]struct_z_loaned_shm_mut_t;
pub extern fn z_shm_mut_try_from_immut(this_: [*c]OwnedShmMut, that: [*c]struct_z_moved_shm_t, immut: [*c]OwnedShm) z_result_t;
pub extern fn z_shm_provider_alloc(out_result: [*c]struct_z_buf_layout_alloc_result_t, provider: [*c]const LoanedShmProvider, size: usize, alignment: AllocAlignment) void;
pub extern fn z_shm_provider_alloc_gc(out_result: [*c]struct_z_buf_layout_alloc_result_t, provider: [*c]const LoanedShmProvider, size: usize, alignment: AllocAlignment) void;
pub extern fn z_shm_provider_alloc_gc_defrag(out_result: [*c]struct_z_buf_layout_alloc_result_t, provider: [*c]const LoanedShmProvider, size: usize, alignment: AllocAlignment) void;
pub extern fn z_shm_provider_alloc_gc_defrag_async(out_result: [*c]struct_z_buf_layout_alloc_result_t, provider: [*c]const LoanedShmProvider, size: usize, alignment: AllocAlignment, result_context: struct_zc_threadsafe_context_t, result_callback: ?*const fn (?*anyopaque, [*c]struct_z_buf_layout_alloc_result_t) callconv(.c) void) z_result_t;
pub extern fn z_shm_provider_alloc_gc_defrag_blocking(out_result: [*c]struct_z_buf_layout_alloc_result_t, provider: [*c]const LoanedShmProvider, size: usize, alignment: AllocAlignment) void;
pub extern fn z_shm_provider_alloc_gc_defrag_dealloc(out_result: [*c]struct_z_buf_layout_alloc_result_t, provider: [*c]const LoanedShmProvider, size: usize, alignment: AllocAlignment) void;
...
pub extern fn z_shm_provider_loan(this_: [*c]const struct_z_owned_shm_provider_t) [*c]const LoanedShmProvider;
pub extern fn z_shm_provider_map(out_result: [*c]OwnedShmMut, provider: [*c]const LoanedShmProvider, allocated_chunk: AllocatedChunk, len: usize) z_result_t;
...
pub extern fn z_shm_try_mut(this_: [*c]OwnedShm) [*c]struct_z_loaned_shm_mut_t;
pub extern fn z_shm_try_reloan_mut(this_: [*c]LoanedShm) [*c]struct_z_loaned_shm_mut_t;
...
pub extern fn z_slice_copy_from_buf(this_: [*c]OwnedSlice, start: [*c]const u8, len: usize) z_result_t;
...
pub extern fn z_slice_from_buf(this_: [*c]OwnedSlice, data: [*c]u8, len: usize, drop: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.c) void, context: ?*anyopaque) z_result_t;
...
pub extern fn z_source_info_id(this_: [*c]const struct_z_loaned_source_info_t) EntityGlobalID;
pub extern fn z_source_info_loan(this_: [*c]const OwnedSourceInfo) [*c]const struct_z_loaned_source_info_t;
pub extern fn z_source_info_new(this_: [*c]OwnedSourceInfo, source_id: [*c]const EntityGlobalID, source_sn: u32) z_result_t;
pub extern fn z_source_info_sn(this_: [*c]const struct_z_loaned_source_info_t) u32;
pub extern fn z_string_array_clone(dst: [*c]OwnedStringArray, this_: [*c]const struct_z_loaned_string_array_t) void;
pub extern fn z_string_array_drop(this_: [*c]struct_z_moved_string_array_t) void;
pub extern fn z_string_array_get(this_: [*c]const struct_z_loaned_string_array_t, index: usize) [*c]const LoanedString;
...
pub extern fn z_string_array_loan(this_: [*c]const OwnedStringArray) [*c]const struct_z_loaned_string_array_t;
pub extern fn z_string_array_loan_mut(this_: [*c]OwnedStringArray) [*c]struct_z_loaned_string_array_t;
pub extern fn z_string_array_new(this_: [*c]OwnedStringArray) void;
pub extern fn z_string_array_push_by_alias(this_: [*c]struct_z_loaned_string_array_t, value: [*c]const LoanedString) usize;
pub extern fn z_string_array_push_by_copy(this_: [*c]struct_z_loaned_string_array_t, value: [*c]const LoanedString) usize;
...
pub extern fn z_string_copy_from_str(this_: [*c]OwnedString, str: [*c]const u8) z_result_t;
pub extern fn z_string_copy_from_substr(this_: [*c]OwnedString, str: [*c]const u8, len: usize) z_result_t;
...
pub extern fn z_string_from_str(this_: [*c]OwnedString, str: [*c]u8, drop: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.c) void, context: ?*anyopaque) z_result_t;
...
pub extern fn z_subscriber_id(subscriber: [*c]const struct_z_loaned_subscriber_t) EntityGlobalID;
pub extern fn z_subscriber_keyexpr(subscriber: [*c]const struct_z_loaned_subscriber_t) [*c]const LoanedKeyexpr;
pub extern fn z_subscriber_loan(this_: [*c]const OwnedSubscriber) [*c]const struct_z_loaned_subscriber_t;
...
pub extern fn z_timestamp_new(this_: [*c]Timestamp, session: [*c]const LoanedSession) z_result_t;
...
pub extern fn z_view_string_loan(this_: [*c]const struct_z_view_string_t) [*c]const LoanedString;
...
pub extern fn ze_advanced_publisher_declare_matching_listener(publisher: [*c]const struct_ze_loaned_advanced_publisher_t, matching_listener: [*c]OwnedMatchingListener, callback: [*c]struct_z_moved_closure_matching_status_t) z_result_t;
...
pub extern fn ze_advanced_subscriber_detect_publishers(subscriber: [*c]const struct_ze_loaned_advanced_subscriber_t, liveliness_subscriber: [*c]OwnedSubscriber, callback: [*c]struct_z_moved_closure_sample_t, options: [*c]struct_z_liveliness_subscriber_options_t) z_result_t;
...
pub extern fn ze_deserialize_int16(this_: [*c]const LoanedBytes, dst: [*c]i16) z_result_t;
pub extern fn ze_deserialize_int32(this_: [*c]const LoanedBytes, dst: [*c]i32) z_result_t;
pub extern fn ze_deserialize_int64(this_: [*c]const LoanedBytes, dst: [*c]i64) z_result_t;
pub extern fn ze_deserialize_int8(this_: [*c]const LoanedBytes, dst: [*c]i8) z_result_t;
pub extern fn ze_deserialize_slice(this_: [*c]const LoanedBytes, slice: [*c]OwnedSlice) z_result_t;
pub extern fn ze_deserialize_string(this_: [*c]const LoanedBytes, str: [*c]OwnedString) z_result_t;
pub extern fn ze_deserialize_uint16(this_: [*c]const LoanedBytes, dst: [*c]u16) z_result_t;
pub extern fn ze_deserialize_uint32(this_: [*c]const LoanedBytes, dst: [*c]u32) z_result_t;
pub extern fn ze_deserialize_uint64(this_: [*c]const LoanedBytes, dst: [*c]u64) z_result_t;
pub extern fn ze_deserialize_uint8(this_: [*c]const LoanedBytes, dst: [*c]u8) z_result_t;
...
pub extern fn ze_deserializer_deserialize_slice(this_: [*c]struct_ze_deserializer_t, slice: [*c]OwnedSlice) z_result_t;
pub extern fn ze_deserializer_deserialize_string(this_: [*c]struct_ze_deserializer_t, str: [*c]OwnedString) z_result_t;
...
pub extern fn ze_serialize_bool(this_: [*c]OwnedBytes, val: bool) z_result_t;
pub extern fn ze_serialize_buf(this_: [*c]OwnedBytes, data: [*c]const u8, len: usize) z_result_t;
pub extern fn ze_serialize_double(this_: [*c]OwnedBytes, val: f64) z_result_t;
pub extern fn ze_serialize_float(this_: [*c]OwnedBytes, val: f32) z_result_t;
pub extern fn ze_serialize_int16(this_: [*c]OwnedBytes, val: i16) z_result_t;
pub extern fn ze_serialize_int32(this_: [*c]OwnedBytes, val: i32) z_result_t;
pub extern fn ze_serialize_int64(this_: [*c]OwnedBytes, val: i64) z_result_t;
pub extern fn ze_serialize_int8(this_: [*c]OwnedBytes, val: i8) z_result_t;
pub extern fn ze_serialize_slice(this_: [*c]OwnedBytes, slice: [*c]const LoanedSlice) z_result_t;
pub extern fn ze_serialize_str(this_: [*c]OwnedBytes, str: [*c]const u8) z_result_t;
pub extern fn ze_serialize_string(this_: [*c]OwnedBytes, str: [*c]const LoanedString) z_result_t;
pub extern fn ze_serialize_substr(this_: [*c]OwnedBytes, start: [*c]const u8, len: usize) z_result_t;
pub extern fn ze_serialize_uint16(this_: [*c]OwnedBytes, val: u16) z_result_t;
pub extern fn ze_serialize_uint32(this_: [*c]OwnedBytes, val: u32) z_result_t;
pub extern fn ze_serialize_uint64(this_: [*c]OwnedBytes, val: u64) z_result_t;
pub extern fn ze_serialize_uint8(this_: [*c]OwnedBytes, val: u8) z_result_t;
...
pub extern fn ze_serializer_serialize_slice(this_: [*c]struct_ze_loaned_serializer_t, slice: [*c]const LoanedSlice) z_result_t;
pub extern fn ze_serializer_serialize_str(this_: [*c]struct_ze_loaned_serializer_t, str: [*c]const u8) z_result_t;
pub extern fn ze_serializer_serialize_string(this_: [*c]struct_ze_loaned_serializer_t, str: [*c]const LoanedString) z_result_t;
...
pub fn z_alloc_layout_move(arg_x: [*c]OwnedAllocLayout) callconv(.c) [*c]z_moved_alloc_layout_t {
    var x = arg_x;
    _ = &x;
...
pub fn z_alloc_layout_take(arg_this_: [*c]OwnedAllocLayout, arg_x: [*c]z_moved_alloc_layout_t) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
