...
pub extern fn z_config_clone(dst: [*c]Config, this_: [*c]const LoanedConfig) void;
pub extern fn z_config_default(this_: [*c]Config) Result;
pub extern fn z_config_drop(this_: [*c]Config) void;
pub extern fn z_config_loan(this_: [*c]const Config) [*c]const LoanedConfig;
pub extern fn z_config_loan_mut(this_: [*c]Config) [*c]LoanedConfig;
pub extern fn z_declare_background_queryable(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureQuery, options: [*c]QueryableOptions) Result;
pub extern fn z_declare_background_subscriber(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureSample, options: [*c]SubscriberOptions) Result;
pub extern fn z_declare_keyexpr(session: [*c]const LoanedSession, declared_key_expr: [*c]Keyexpr, key_expr: [*c]const LoanedKeyexpr) Result;
pub extern fn z_declare_publisher(session: [*c]const LoanedSession, publisher: [*c]Publisher, key_expr: [*c]const LoanedKeyexpr, options: [*c]PublisherOptions) Result;
pub extern fn z_declare_querier(session: [*c]const LoanedSession, querier: [*c]Querier, key_expr: [*c]const LoanedKeyexpr, options: [*c]QuerierOptions) Result;
pub extern fn z_declare_queryable(session: [*c]const LoanedSession, queryable: [*c]Queryable, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureQuery, options: [*c]QueryableOptions) Result;
pub extern fn z_declare_subscriber(session: [*c]const LoanedSession, subscriber: [*c]Subscriber, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureSample, options: [*c]SubscriberOptions) Result;
...
pub extern fn z_get(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, parameters: [*c]const u8, callback: [*c]ClosureReply, options: [*c]GetOptions) Result;
...
pub extern fn z_info_peers_zid(session: [*c]const LoanedSession, callback: [*c]ClosureZid) Result;
pub extern fn z_info_routers_zid(session: [*c]const LoanedSession, callback: [*c]ClosureZid) Result;
...
pub extern fn z_internal_config_check(this_: [*c]const Config) bool;
pub extern fn z_internal_config_null(this_: [*c]Config) void;
...
pub extern fn z_internal_session_check(this_: [*c]const Session) bool;
pub extern fn z_internal_session_null(this_: [*c]Session) void;
...
pub extern fn z_liveliness_declare_background_subscriber(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureSample, options: [*c]LivelinessSubscriberOptions) Result;
pub extern fn z_liveliness_declare_subscriber(session: [*c]const LoanedSession, subscriber: [*c]Subscriber, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureSample, options: [*c]LivelinessSubscriberOptions) Result;
pub extern fn z_liveliness_declare_token(session: [*c]const LoanedSession, token: [*c]LivelinessToken, key_expr: [*c]const LoanedKeyexpr, _options: [*c]const LivelinessTokenOptions) Result;
pub extern fn z_liveliness_get(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureReply, options: [*c]LivelinessGetOptions) Result;
...
pub extern fn z_open(this_: [*c]Session, config: [*c]Config, _options: [*c]const OpenOptions) Result;
pub extern fn z_open_options_default(this_: [*c]OpenOptions) void;
pub extern fn z_open_with_custom_shm_clients(this_: [*c]Session, config: [*c]Config, shm_clients: [*c]const LoanedShmClientStorage) Result;
...
pub extern fn z_put(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, payload: [*c]Bytes, options: [*c]PutOptions) Result;
...
pub extern fn z_scout(config: [*c]Config, callback: [*c]ClosureHello, options: [*c]const ScoutOptions) Result;
pub extern fn z_scout_options_default(this_: [*c]ScoutOptions) void;
pub extern fn z_session_drop(this_: [*c]Session) void;
pub extern fn z_session_is_closed(session: [*c]const LoanedSession) bool;
pub extern fn z_session_loan(this_: [*c]const Session) [*c]const LoanedSession;
pub extern fn z_session_loan_mut(this_: [*c]Session) [*c]LoanedSession;
...
pub extern fn z_undeclare_keyexpr(session: [*c]const LoanedSession, key_expr: [*c]Keyexpr) Result;
...
pub extern fn zc_config_from_env(this_: [*c]Config) Result;
pub extern fn zc_config_from_file(this_: [*c]Config, path: [*c]const u8) Result;
pub extern fn zc_config_from_str(this_: [*c]Config, s: [*c]const u8) Result;
pub extern fn zc_config_get_from_str(this_: [*c]const LoanedConfig, key: [*c]const u8, out_value_string: [*c]String) Result;
pub extern fn zc_config_get_from_substr(this_: [*c]const LoanedConfig, key: [*c]const u8, key_len: usize, out_value_string: [*c]String) Result;
...
pub extern fn zc_config_to_string(config: [*c]const LoanedConfig, out_config_string: [*c]String) Result;
...
pub extern fn ze_declare_advanced_publisher(session: [*c]const LoanedSession, publisher: [*c]ze_advanced_publisher_t, key_expr: [*c]const LoanedKeyexpr, options: [*c]ze_advanced_publisher_options_t) Result;
pub extern fn ze_declare_advanced_subscriber(session: [*c]const LoanedSession, subscriber: [*c]ze_advanced_subscriber_t, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureSample, options: [*c]ze_advanced_subscriber_options_t) Result;
pub extern fn ze_declare_background_advanced_subscriber(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureSample, options: [*c]ze_advanced_subscriber_options_t) Result;
pub extern fn ze_declare_background_publication_cache(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, options: [*c]ze_publication_cache_options_t) Result;
pub extern fn ze_declare_background_querying_subscriber(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureSample, options: [*c]ze_querying_subscriber_options_t) Result;
pub extern fn ze_declare_publication_cache(session: [*c]const LoanedSession, pub_cache: [*c]ze_publication_cache_t, key_expr: [*c]const LoanedKeyexpr, options: [*c]ze_publication_cache_options_t) Result;
pub extern fn ze_declare_querying_subscriber(session: [*c]const LoanedSession, querying_subscriber: [*c]ze_querying_subscriber_t, key_expr: [*c]const LoanedKeyexpr, callback: [*c]ClosureSample, options: [*c]ze_querying_subscriber_options_t) Result;
