...
pub const OwnedClosureHello = extern struct {
...
pub const MovedClosureHello = extern struct {
    _this: OwnedClosureHello = @import("std").mem.zeroes(OwnedClosureHello),
};
pub const MatchingStatus = extern struct {
    matching: bool = @import("std").mem.zeroes(bool),
};
pub const OwnedClosureMatchingStatus = extern struct {
    _context: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
...
pub const OwnedClosureSample = extern struct {
    _context: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
...
pub const MovedClosureSample = extern struct {
    _this: OwnedClosureSample = @import("std").mem.zeroes(OwnedClosureSample),
};
pub const OwnedClosureZID = extern struct {
    _context: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    _call: ?*const fn ([*c]const ID, ?*anyopaque) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]const ID, ?*anyopaque) callconv(.c) void),
    _drop: ?*const fn (?*anyopaque) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*anyopaque) callconv(.c) void),
};
pub const MovedClosureZID = extern struct {
    _this: OwnedClosureZID = @import("std").mem.zeroes(OwnedClosureZID),
};
pub const MovedCondvar = extern struct {
    _this: OwnedCondvar = @import("std").mem.zeroes(OwnedCondvar),
};
pub const MovedConfig = extern struct {
...
pub const MovedEncoding = extern struct {
    _this: OwnedEncoding = @import("std").mem.zeroes(OwnedEncoding),
};
pub const PublisherOptions = extern struct {
    encoding: [*c]MovedEncoding = @import("std").mem.zeroes([*c]MovedEncoding),
...
pub const GetOptions = extern struct {
    ...
    accept_replies: enum_zc_reply_keyexpr_t = @import("std").mem.zeroes(enum_zc_reply_keyexpr_t),
    priority: enum_z_priority_t = @import("std").mem.zeroes(enum_z_priority_t),
    source_info: [*c]MovedSourceInfo = @import("std").mem.zeroes([*c]MovedSourceInfo),
    attachment: [*c]MovedBytes = @import("std").mem.zeroes([*c]MovedBytes),
    timeout_ms: u64 = @import("std").mem.zeroes(u64),
};
pub const MovedHello = extern struct {
    _this: OwnedHello = @import("std").mem.zeroes(OwnedHello),
};
pub const MovedKeyexpr = extern struct {
...
pub const MovedPublisher = extern struct {
...
pub const MovedQuerier = extern struct {
...
pub const MovedQuery = extern struct {
...
pub extern fn z_bytes_drop(this_: [*c]MovedBytes) void;
...
pub extern fn z_bytes_from_shm(this_: [*c]OwnedBytes, shm: [*c]MovedShm) Result;
pub extern fn z_bytes_from_shm_mut(this_: [*c]OwnedBytes, shm: [*c]MovedShmMut) Result;
pub extern fn z_bytes_from_slice(this_: [*c]OwnedBytes, slice: [*c]MovedSlice) void;
...
pub extern fn z_bytes_from_string(this_: [*c]OwnedBytes, s: [*c]MovedString) void;
...
pub extern fn z_bytes_writer_append(this_: [*c]LoanedBytesWriter, bytes: [*c]MovedBytes) Result;
pub extern fn z_bytes_writer_drop(this_: [*c]MovedBytesWriter) void;
pub extern fn z_bytes_writer_empty(this_: [*c]OwnedBytesWriter) Result;
pub extern fn z_bytes_writer_finish(this_: [*c]MovedBytesWriter, bytes: [*c]OwnedBytes) void;
...
pub extern fn z_chunk_alloc_result_drop(this_: [*c]MovedChunkAllocResult) void;
...
pub extern fn z_close(session: [*c]LoanedSession, options: [*c]CloseOptions) Result;
pub extern fn z_close_options_default(this_: [*c]CloseOptions) void;
pub extern fn z_closure_hello(this_: [*c]OwnedClosureHello, call: ?*const fn ([*c]LoanedHello, ?*anyopaque) callconv(.c) void, drop: ?*const fn (?*anyopaque) callconv(.c) void, context: ?*anyopaque) void;
pub extern fn z_closure_hello_call(closure: [*c]const LoanedClosureHello, hello: [*c]LoanedHello) void;
pub extern fn z_closure_hello_drop(this_: [*c]MovedClosureHello) void;
pub extern fn z_closure_hello_loan(closure: [*c]const OwnedClosureHello) [*c]const LoanedClosureHello;
pub extern fn z_closure_hello_loan_mut(closure: [*c]OwnedClosureHello) [*c]LoanedClosureHello;
pub extern fn z_closure_matching_status(this_: [*c]OwnedClosureMatchingStatus, call: ?*const fn ([*c]const MatchingStatus, ?*anyopaque) callconv(.c) void, drop: ?*const fn (?*anyopaque) callconv(.c) void, context: ?*anyopaque) void;
...
pub extern fn z_closure_sample(this_: [*c]OwnedClosureSample, call: ?*const fn ([*c]LoanedSample, ?*anyopaque) callconv(.c) void, drop: ?*const fn (?*anyopaque) callconv(.c) void, context: ?*anyopaque) void;
pub extern fn z_closure_sample_call(closure: [*c]const LoanedClosureSample, sample: [*c]LoanedSample) void;
pub extern fn z_closure_sample_drop(closure_: [*c]MovedClosureSample) void;
pub extern fn z_closure_sample_loan(closure: [*c]const OwnedClosureSample) [*c]const LoanedClosureSample;
pub extern fn z_closure_sample_loan_mut(closure: [*c]OwnedClosureSample) [*c]LoanedClosureSample;
pub extern fn z_closure_zid(this_: [*c]OwnedClosureZID, call: ?*const fn ([*c]const ID, ?*anyopaque) callconv(.c) void, drop: ?*const fn (?*anyopaque) callconv(.c) void, context: ?*anyopaque) void;
pub extern fn z_closure_zid_call(closure: [*c]const LoanedClosureZID, z_id: [*c]const ID) void;
pub extern fn z_closure_zid_drop(closure_: [*c]MovedClosureZID) void;
pub extern fn z_closure_zid_loan(closure: [*c]const OwnedClosureZID) [*c]const LoanedClosureZID;
pub extern fn z_closure_zid_loan_mut(closure: [*c]const OwnedClosureZID) [*c]const LoanedClosureZID;
pub extern fn z_condvar_drop(this_: [*c]MovedCondvar) void;
...
pub extern fn z_config_drop(this_: [*c]MovedConfig) void;
...
pub extern fn z_declare_background_queryable(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureQuery, options: [*c]QueryableOptions) Result;
pub extern fn z_declare_background_subscriber(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureSample, options: [*c]SubscriberOptions) Result;
...
pub extern fn z_declare_publisher(session: [*c]const LoanedSession, publisher: [*c]OwnedPublisher, key_expr: [*c]const LoanedKeyexpr, options: [*c]PublisherOptions) Result;
pub extern fn z_declare_querier(session: [*c]const LoanedSession, querier: [*c]OwnedQuerier, key_expr: [*c]const LoanedKeyexpr, options: [*c]QuerierOptions) Result;
pub extern fn z_declare_queryable(session: [*c]const LoanedSession, queryable: [*c]OwnedQueryable, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureQuery, options: [*c]QueryableOptions) Result;
pub extern fn z_declare_subscriber(session: [*c]const LoanedSession, subscriber: [*c]OwnedSubscriber, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureSample, options: [*c]SubscriberOptions) Result;
pub extern fn z_delete(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, options: [*c]DeleteOptions) Result;
...
pub extern fn z_encoding_drop(this_: [*c]MovedEncoding) void;
...
pub extern fn z_fifo_channel_sample_new(callback: [*c]OwnedClosureSample, handler: [*c]OwnedFifoHandlerSample, capacity: usize) void;
pub extern fn z_fifo_handler_query_drop(this_: [*c]MovedFifoHandlerQuery) void;
...
pub extern fn z_fifo_handler_reply_drop(this_: [*c]MovedFifoHandlerReply) void;
...
pub extern fn z_fifo_handler_sample_drop(this_: [*c]MovedFifoHandlerSample) void;
...
pub extern fn z_get(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, parameters: [*c]const u8, callback: [*c]MovedClosureReply, options: [*c]GetOptions) Result;
...
pub extern fn z_hello_drop(this_: [*c]MovedHello) void;
...
pub extern fn z_info_peers_zid(session: [*c]const LoanedSession, callback: [*c]MovedClosureZID) Result;
pub extern fn z_info_routers_zid(session: [*c]const LoanedSession, callback: [*c]MovedClosureZID) Result;
...
pub extern fn z_internal_closure_hello_check(this_: [*c]const OwnedClosureHello) bool;
...
pub extern fn z_internal_closure_sample_check(this_: [*c]const OwnedClosureSample) bool;
pub extern fn z_internal_closure_sample_null(this_: [*c]OwnedClosureSample) void;
pub extern fn z_internal_closure_zid_check(this_: [*c]const OwnedClosureZID) bool;
pub extern fn z_internal_closure_zid_null(this_: [*c]OwnedClosureZID) void;
...
pub extern fn z_keyexpr_drop(this_: [*c]MovedKeyexpr) void;
...
pub extern fn z_liveliness_declare_background_subscriber(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureSample, options: [*c]LivelinessSubscriberOptions) Result;
pub extern fn z_liveliness_declare_subscriber(session: [*c]const LoanedSession, subscriber: [*c]OwnedSubscriber, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureSample, options: [*c]LivelinessSubscriberOptions) Result;
pub extern fn z_liveliness_declare_token(session: [*c]const LoanedSession, token: [*c]OwnedLivelinessToken, key_expr: [*c]const LoanedKeyexpr, _options: [*c]const LivelinessTokenOptions) Result;
pub extern fn z_liveliness_get(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureReply, options: [*c]LivelinessGetOptions) Result;
...
pub extern fn z_liveliness_token_drop(this_: [*c]MovedLivelinessToken) void;
...
pub extern fn z_liveliness_undeclare_token(this_: [*c]MovedLivelinessToken) Result;
pub extern fn z_matching_listener_drop(this_: [*c]MovedMatchingListener) void;
pub extern fn z_memory_layout_drop(this_: [*c]MovedMemoryLayout) void;
...
pub extern fn z_mutex_drop(this_: [*c]MovedMutex) void;
...
pub extern fn z_open(this_: [*c]OwnedSession, config: [*c]MovedConfig, _options: [*c]const OpenOptions) Result;
pub extern fn z_open_options_default(this_: [*c]OpenOptions) void;
pub extern fn z_open_with_custom_shm_clients(this_: [*c]OwnedSession, config: [*c]MovedConfig, shm_clients: [*c]const LoanedShmClientStorage) Result;
...
pub extern fn z_publisher_declare_background_matching_listener(publisher: [*c]const LoanedPublisher, callback: [*c]MovedClosureMatchingStatus) Result;
pub extern fn z_publisher_declare_matching_listener(publisher: [*c]const LoanedPublisher, matching_listener: [*c]OwnedMatchingListener, callback: [*c]MovedClosureMatchingStatus) Result;
...
pub extern fn z_publisher_drop(this_: [*c]MovedPublisher) void;
...
pub extern fn z_publisher_put(this_: [*c]const LoanedPublisher, payload: [*c]MovedBytes, options: [*c]PublisherPutOptions) Result;
pub extern fn z_publisher_put_options_default(this_: [*c]PublisherPutOptions) void;
pub extern fn z_put(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, payload: [*c]MovedBytes, options: [*c]PutOptions) Result;
...
pub extern fn z_querier_drop(this_: [*c]MovedQuerier) void;
pub extern fn z_querier_get(querier: [*c]const LoanedQuerier, parameters: [*c]const u8, callback: [*c]MovedClosureReply, options: [*c]QuerierGetOptions) Result;
...
pub extern fn z_query_drop(this_: [*c]MovedQuery) void;
...
pub extern fn z_query_reply(this_: [*c]const LoanedQuery, key_expr: [*c]const LoanedKeyexpr, payload: [*c]MovedBytes, options: [*c]QueryReplyOptions) Result;
...
pub extern fn z_queryable_drop(this_: [*c]MovedQueryable) void;
...
pub extern fn z_reply_drop(this_: [*c]MovedReply) void;
...
pub extern fn z_reply_err_drop(this_: [*c]MovedReplyErr) void;
...
pub extern fn z_ring_channel_sample_new(callback: [*c]OwnedClosureSample, handler: [*c]OwnedRingHandlerSample, capacity: usize) void;
pub extern fn z_ring_handler_query_drop(this_: [*c]MovedRingHandlerQuery) void;
...
pub extern fn z_ring_handler_reply_drop(this_: [*c]MovedRingHandlerReply) void;
...
pub extern fn z_ring_handler_sample_drop(this_: [*c]MovedRingHandlerSample) void;
...
pub extern fn z_sample_drop(this_: [*c]MovedSample) void;
...
pub extern fn z_scout(config: [*c]MovedConfig, callback: [*c]MovedClosureHello, options: [*c]const ScoutOptions) Result;
pub extern fn z_scout_options_default(this_: [*c]ScoutOptions) void;
pub extern fn z_session_drop(this_: [*c]MovedSession) void;
...
pub extern fn z_shm_client_drop(this_: [*c]MovedShmClient) void;
...
pub extern fn z_shm_client_storage_drop(this_: [*c]MovedShmClientStorage) void;
...
pub extern fn z_shm_drop(this_: [*c]MovedShm) void;
pub extern fn z_shm_from_mut(this_: [*c]OwnedShm, that: [*c]MovedShmMut) void;
...
pub extern fn z_shm_mut_drop(this_: [*c]MovedShmMut) void;
...
pub extern fn z_shm_mut_try_from_immut(this_: [*c]OwnedShmMut, that: [*c]MovedShm, immut: [*c]OwnedShm) Result;
...
pub extern fn z_shm_provider_drop(this_: [*c]MovedShmProvider) void;
...
pub extern fn z_shm_provider_new(this_: [*c]OwnedShmProvider, id: ProtocolID, context: struct_zc_context_t, callbacks: struct_zc_shm_provider_backend_callbacks_t) void;
pub extern fn z_shm_provider_threadsafe_new(this_: [*c]OwnedShmProvider, id: ProtocolID, context: struct_zc_threadsafe_context_t, callbacks: struct_zc_shm_provider_backend_callbacks_t) void;
...
pub extern fn z_slice_drop(this_: [*c]MovedSlice) void;
...
pub extern fn z_source_info_drop(this_: [*c]MovedSourceInfo) void;
...
pub extern fn z_string_array_drop(this_: [*c]MovedStringArray) void;
...
pub extern fn z_string_drop(this_: [*c]MovedString) void;
...
pub extern fn z_subscriber_drop(this_: [*c]MovedSubscriber) void;
...
pub extern fn z_task_detach(this_: [*c]MovedTask) void;
pub extern fn z_task_drop(this_: [*c]MovedTask) void;
pub extern fn z_task_init(this_: [*c]OwnedTask, _attr: [*c]const TaskAttr, fun: ?*const fn (?*anyopaque) callconv(.c) ?*anyopaque, arg: ?*anyopaque) Result;
pub extern fn z_task_join(this_: [*c]MovedTask) Result;
...
pub extern fn z_undeclare_keyexpr(session: [*c]const LoanedSession, key_expr: [*c]MovedKeyexpr) Result;
pub extern fn z_undeclare_matching_listener(this_: [*c]MovedMatchingListener) Result;
pub extern fn z_undeclare_publisher(this_: [*c]MovedPublisher) Result;
pub extern fn z_undeclare_querier(this_: [*c]MovedQuerier) Result;
pub extern fn z_undeclare_queryable(this_: [*c]MovedQueryable) Result;
pub extern fn z_undeclare_subscriber(this_: [*c]MovedSubscriber) Result;
...
pub extern fn zc_shm_client_list_add_client(this_: [*c]struct_zc_loaned_shm_client_list_t, id: ProtocolID, client: [*c]MovedShmClient) Result;
...
pub extern fn ze_advanced_publisher_declare_background_matching_listener(publisher: [*c]const struct_ze_loaned_advanced_publisher_t, callback: [*c]MovedClosureMatchingStatus) Result;
pub extern fn ze_advanced_publisher_declare_matching_listener(publisher: [*c]const struct_ze_loaned_advanced_publisher_t, matching_listener: [*c]OwnedMatchingListener, callback: [*c]MovedClosureMatchingStatus) Result;
...
pub extern fn ze_advanced_publisher_get_matching_status(this_: [*c]const struct_ze_loaned_advanced_publisher_t, matching_status: [*c]MatchingStatus) Result;
...
pub extern fn ze_advanced_publisher_put(this_: [*c]const struct_ze_loaned_advanced_publisher_t, payload: [*c]MovedBytes, options: [*c]struct_ze_advanced_publisher_put_options_t) Result;
...
pub extern fn ze_advanced_subscriber_detect_publishers(subscriber: [*c]const struct_ze_loaned_advanced_subscriber_t, liveliness_subscriber: [*c]OwnedSubscriber, callback: [*c]MovedClosureSample, options: [*c]LivelinessSubscriberOptions) Result;
pub extern fn ze_advanced_subscriber_detect_publishers_background(subscriber: [*c]const struct_ze_loaned_advanced_subscriber_t, callback: [*c]MovedClosureSample, options: [*c]LivelinessSubscriberOptions) Result;
...
pub extern fn ze_declare_advanced_subscriber(session: [*c]const LoanedSession, subscriber: [*c]struct_ze_owned_advanced_subscriber_t, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureSample, options: [*c]struct_ze_advanced_subscriber_options_t) Result;
pub extern fn ze_declare_background_advanced_subscriber(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureSample, options: [*c]struct_ze_advanced_subscriber_options_t) Result;
...
pub extern fn ze_declare_background_querying_subscriber(session: [*c]const LoanedSession, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureSample, options: [*c]struct_ze_querying_subscriber_options_t) Result;
...
pub extern fn ze_declare_querying_subscriber(session: [*c]const LoanedSession, querying_subscriber: [*c]struct_ze_owned_querying_subscriber_t, key_expr: [*c]const LoanedKeyexpr, callback: [*c]MovedClosureSample, options: [*c]struct_ze_querying_subscriber_options_t) Result;
...
pub extern fn ze_querying_subscriber_get(this_: [*c]const struct_ze_loaned_querying_subscriber_t, selector: [*c]const LoanedKeyexpr, options: [*c]GetOptions) Result;
...
pub fn z_bytes_writer_move(arg_x: [*c]OwnedBytesWriter) callconv(.c) [*c]MovedBytesWriter {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedBytesWriter, @ptrCast(@alignCast(x)));
}
pub fn z_chunk_alloc_result_move(arg_x: [*c]OwnedChunkAllocResult) callconv(.c) [*c]MovedChunkAllocResult {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedChunkAllocResult, @ptrCast(@alignCast(x)));
}
pub fn z_closure_hello_move(arg_x: [*c]OwnedClosureHello) callconv(.c) [*c]MovedClosureHello {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedClosureHello, @ptrCast(@alignCast(x)));
}
pub fn z_closure_matching_status_move(arg_x: [*c]OwnedClosureMatchingStatus) callconv(.c) [*c]MovedClosureMatchingStatus {
    var x = arg_x;
    _ = &x;
...
pub fn z_closure_sample_move(arg_x: [*c]OwnedClosureSample) callconv(.c) [*c]MovedClosureSample {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedClosureSample, @ptrCast(@alignCast(x)));
}
pub fn z_closure_zid_move(arg_x: [*c]OwnedClosureZID) callconv(.c) [*c]MovedClosureZID {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedClosureZID, @ptrCast(@alignCast(x)));
}
pub fn z_condvar_move(arg_x: [*c]OwnedCondvar) callconv(.c) [*c]MovedCondvar {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedCondvar, @ptrCast(@alignCast(x)));
}
pub fn z_config_move(arg_x: [*c]OwnedConfig) callconv(.c) [*c]MovedConfig {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedConfig, @ptrCast(@alignCast(x)));
}
pub fn z_encoding_move(arg_x: [*c]OwnedEncoding) callconv(.c) [*c]MovedEncoding {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedEncoding, @ptrCast(@alignCast(x)));
}
pub fn z_fifo_handler_query_move(arg_x: [*c]OwnedFifoHandlerQuery) callconv(.c) [*c]MovedFifoHandlerQuery {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedFifoHandlerQuery, @ptrCast(@alignCast(x)));
}
pub fn z_fifo_handler_reply_move(arg_x: [*c]OwnedFifoHandlerReply) callconv(.c) [*c]MovedFifoHandlerReply {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedFifoHandlerReply, @ptrCast(@alignCast(x)));
}
pub fn z_fifo_handler_sample_move(arg_x: [*c]OwnedFifoHandlerSample) callconv(.c) [*c]MovedFifoHandlerSample {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedFifoHandlerSample, @ptrCast(@alignCast(x)));
}
pub fn z_hello_move(arg_x: [*c]OwnedHello) callconv(.c) [*c]MovedHello {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedHello, @ptrCast(@alignCast(x)));
}
pub fn z_keyexpr_move(arg_x: [*c]OwnedKeyexpr) callconv(.c) [*c]MovedKeyexpr {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedKeyexpr, @ptrCast(@alignCast(x)));
}
pub fn z_liveliness_token_move(arg_x: [*c]OwnedLivelinessToken) callconv(.c) [*c]MovedLivelinessToken {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedLivelinessToken, @ptrCast(@alignCast(x)));
}
pub fn z_matching_listener_move(arg_x: [*c]OwnedMatchingListener) callconv(.c) [*c]MovedMatchingListener {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedMatchingListener, @ptrCast(@alignCast(x)));
}
pub fn z_memory_layout_move(arg_x: [*c]OwnedMemoryLayout) callconv(.c) [*c]MovedMemoryLayout {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedMemoryLayout, @ptrCast(@alignCast(x)));
}
pub fn z_mutex_move(arg_x: [*c]OwnedMutex) callconv(.c) [*c]MovedMutex {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedMutex, @ptrCast(@alignCast(x)));
}
pub fn z_publisher_move(arg_x: [*c]OwnedPublisher) callconv(.c) [*c]MovedPublisher {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedPublisher, @ptrCast(@alignCast(x)));
}
pub fn z_querier_move(arg_x: [*c]OwnedQuerier) callconv(.c) [*c]MovedQuerier {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedQuerier, @ptrCast(@alignCast(x)));
}
pub fn z_query_move(arg_x: [*c]OwnedQuery) callconv(.c) [*c]MovedQuery {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedQuery, @ptrCast(@alignCast(x)));
}
pub fn z_queryable_move(arg_x: [*c]OwnedQueryable) callconv(.c) [*c]MovedQueryable {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedQueryable, @ptrCast(@alignCast(x)));
}
pub fn z_reply_move(arg_x: [*c]OwnedReply) callconv(.c) [*c]MovedReply {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedReply, @ptrCast(@alignCast(x)));
}
pub fn z_reply_err_move(arg_x: [*c]OwnedReplyErr) callconv(.c) [*c]MovedReplyErr {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedReplyErr, @ptrCast(@alignCast(x)));
}
pub fn z_ring_handler_query_move(arg_x: [*c]OwnedRingHandlerQuery) callconv(.c) [*c]MovedRingHandlerQuery {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedRingHandlerQuery, @ptrCast(@alignCast(x)));
}
pub fn z_ring_handler_reply_move(arg_x: [*c]OwnedRingHandlerReply) callconv(.c) [*c]MovedRingHandlerReply {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedRingHandlerReply, @ptrCast(@alignCast(x)));
}
pub fn z_ring_handler_sample_move(arg_x: [*c]OwnedRingHandlerSample) callconv(.c) [*c]MovedRingHandlerSample {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedRingHandlerSample, @ptrCast(@alignCast(x)));
}
pub fn z_sample_move(arg_x: [*c]OwnedSample) callconv(.c) [*c]MovedSample {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedSample, @ptrCast(@alignCast(x)));
}
pub fn z_session_move(arg_x: [*c]OwnedSession) callconv(.c) [*c]MovedSession {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedSession, @ptrCast(@alignCast(x)));
}
pub fn z_shm_client_move(arg_x: [*c]OwnedShmClient) callconv(.c) [*c]MovedShmClient {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedShmClient, @ptrCast(@alignCast(x)));
}
pub fn z_shm_client_storage_move(arg_x: [*c]OwnedShmClientStorage) callconv(.c) [*c]MovedShmClientStorage {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedShmClientStorage, @ptrCast(@alignCast(x)));
}
pub fn z_shm_move(arg_x: [*c]OwnedShm) callconv(.c) [*c]MovedShm {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedShm, @ptrCast(@alignCast(x)));
}
pub fn z_shm_mut_move(arg_x: [*c]OwnedShmMut) callconv(.c) [*c]MovedShmMut {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedShmMut, @ptrCast(@alignCast(x)));
}
pub fn z_shm_provider_move(arg_x: [*c]OwnedShmProvider) callconv(.c) [*c]MovedShmProvider {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedShmProvider, @ptrCast(@alignCast(x)));
}
pub fn z_slice_move(arg_x: [*c]OwnedSlice) callconv(.c) [*c]MovedSlice {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedSlice, @ptrCast(@alignCast(x)));
}
pub fn z_source_info_move(arg_x: [*c]OwnedSourceInfo) callconv(.c) [*c]MovedSourceInfo {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedSourceInfo, @ptrCast(@alignCast(x)));
}
pub fn z_string_array_move(arg_x: [*c]OwnedStringArray) callconv(.c) [*c]MovedStringArray {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedStringArray, @ptrCast(@alignCast(x)));
}
pub fn z_string_move(arg_x: [*c]OwnedString) callconv(.c) [*c]MovedString {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedString, @ptrCast(@alignCast(x)));
}
pub fn z_subscriber_move(arg_x: [*c]OwnedSubscriber) callconv(.c) [*c]MovedSubscriber {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedSubscriber, @ptrCast(@alignCast(x)));
}
pub fn z_task_move(arg_x: [*c]OwnedTask) callconv(.c) [*c]MovedTask {
    var x = arg_x;
    _ = &x;
    return @as([*c]MovedTask, @ptrCast(@alignCast(x)));
}
...
pub fn z_bytes_writer_take(arg_this_: [*c]OwnedBytesWriter, arg_x: [*c]MovedBytesWriter) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_chunk_alloc_result_take(arg_this_: [*c]OwnedChunkAllocResult, arg_x: [*c]MovedChunkAllocResult) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_closure_hello_take(arg_this_: [*c]OwnedClosureHello, arg_x: [*c]MovedClosureHello) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_closure_matching_status_take(arg_closure_: [*c]OwnedClosureMatchingStatus, arg_x: [*c]MovedClosureMatchingStatus) callconv(.c) void {
...
pub fn z_closure_sample_take(arg_closure_: [*c]OwnedClosureSample, arg_x: [*c]MovedClosureSample) callconv(.c) void {
    var closure_ = arg_closure_;
    _ = &closure_;
    var x = arg_x;
    _ = &x;
...
pub fn z_closure_zid_take(arg_closure_: [*c]OwnedClosureZID, arg_x: [*c]MovedClosureZID) callconv(.c) void {
    var closure_ = arg_closure_;
    _ = &closure_;
    var x = arg_x;
    _ = &x;
...
pub fn z_condvar_take(arg_this_: [*c]OwnedCondvar, arg_x: [*c]MovedCondvar) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_config_take(arg_this_: [*c]OwnedConfig, arg_x: [*c]MovedConfig) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_encoding_take(arg_this_: [*c]OwnedEncoding, arg_x: [*c]MovedEncoding) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_fifo_handler_query_take(arg_this_: [*c]OwnedFifoHandlerQuery, arg_x: [*c]MovedFifoHandlerQuery) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_fifo_handler_reply_take(arg_this_: [*c]OwnedFifoHandlerReply, arg_x: [*c]MovedFifoHandlerReply) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_fifo_handler_sample_take(arg_this_: [*c]OwnedFifoHandlerSample, arg_x: [*c]MovedFifoHandlerSample) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_hello_take(arg_this_: [*c]OwnedHello, arg_x: [*c]MovedHello) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_keyexpr_take(arg_this_: [*c]OwnedKeyexpr, arg_x: [*c]MovedKeyexpr) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_liveliness_token_take(arg_this_: [*c]OwnedLivelinessToken, arg_x: [*c]MovedLivelinessToken) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_matching_listener_take(arg_this_: [*c]OwnedMatchingListener, arg_x: [*c]MovedMatchingListener) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_memory_layout_take(arg_this_: [*c]OwnedMemoryLayout, arg_x: [*c]MovedMemoryLayout) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_mutex_take(arg_this_: [*c]OwnedMutex, arg_x: [*c]MovedMutex) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_publisher_take(arg_this_: [*c]OwnedPublisher, arg_x: [*c]MovedPublisher) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_querier_take(arg_this_: [*c]OwnedQuerier, arg_x: [*c]MovedQuerier) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_query_take(arg_this_: [*c]OwnedQuery, arg_x: [*c]MovedQuery) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_queryable_take(arg_this_: [*c]OwnedQueryable, arg_x: [*c]MovedQueryable) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_reply_take(arg_this_: [*c]OwnedReply, arg_x: [*c]MovedReply) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_reply_err_take(arg_this_: [*c]OwnedReplyErr, arg_x: [*c]MovedReplyErr) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_ring_handler_query_take(arg_this_: [*c]OwnedRingHandlerQuery, arg_x: [*c]MovedRingHandlerQuery) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_ring_handler_reply_take(arg_this_: [*c]OwnedRingHandlerReply, arg_x: [*c]MovedRingHandlerReply) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_ring_handler_sample_take(arg_this_: [*c]OwnedRingHandlerSample, arg_x: [*c]MovedRingHandlerSample) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_sample_take(arg_this_: [*c]OwnedSample, arg_x: [*c]MovedSample) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_session_take(arg_this_: [*c]OwnedSession, arg_x: [*c]MovedSession) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_shm_client_take(arg_this_: [*c]OwnedShmClient, arg_x: [*c]MovedShmClient) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_shm_client_storage_take(arg_this_: [*c]OwnedShmClientStorage, arg_x: [*c]MovedShmClientStorage) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_shm_take(arg_this_: [*c]OwnedShm, arg_x: [*c]MovedShm) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_shm_mut_take(arg_this_: [*c]OwnedShmMut, arg_x: [*c]MovedShmMut) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_shm_provider_take(arg_this_: [*c]OwnedShmProvider, arg_x: [*c]MovedShmProvider) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_slice_take(arg_this_: [*c]OwnedSlice, arg_x: [*c]MovedSlice) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_source_info_take(arg_this_: [*c]OwnedSourceInfo, arg_x: [*c]MovedSourceInfo) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_string_array_take(arg_this_: [*c]OwnedStringArray, arg_x: [*c]MovedStringArray) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_string_take(arg_this_: [*c]OwnedString, arg_x: [*c]MovedString) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_subscriber_take(arg_this_: [*c]OwnedSubscriber, arg_x: [*c]MovedSubscriber) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
...
pub fn z_task_take(arg_this_: [*c]OwnedTask, arg_x: [*c]MovedTask) callconv(.c) void {
    var this_ = arg_this_;
    _ = &this_;
    var x = arg_x;
    _ = &x;
